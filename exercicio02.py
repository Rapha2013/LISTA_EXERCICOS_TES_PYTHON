...
# O usuário digital o tamanho do tabuleiro.
...
# tabuleiro: É o tabuleiro do jogo, representado por uma matriz NxN, inicialmente vazio.
# criar_tabuleiro: Função onde o usuário digital o tamanho do tabuleiro.
...
def imprimir_tabuleiro(tabuleiro):
    ...
    for linha in tabuleiro:
        ...
        print(" | ".join(linha))
        # Imprime uma linha horizontal com base no tamanho da linha do tabuleiro.
        print("-" * (4 * len(linha) - 1))
...
# Define uma função para criar um tabuleiro com o tamanho especificado.
def criar_tabuleiro(tamanho):
    return [[" " for _ in range(tamanho)] for _ in range(tamanho)]

# Define a função principal do jogo.
def jogo_da_velha():
    # Solicita ao jogador que escolha o tamanho do tabuleiro.
    tamanho = int(input("Digite o tamanho do tabuleiro: "))

    # Cria um tabuleiro com o tamanho especificado.
    tabuleiro = criar_tabuleiro(tamanho)
    jogador_atual = "X"  # Define o jogador atual como "X".
    jogadas = 0  # Inicializa o contador de jogadas.
    total_jogadas = tamanho * tamanho  # Calcula o número total de jogadas permitidas.
    ...
    while True:
        ...
        linha = int(input(f"Jogador {jogador_atual}, escolha a linha (1-{tamanho}): ")) - 1
        coluna = int(input(f"Jogador {jogador_atual}, escolha a coluna (1-{tamanho}): ")) - 1
